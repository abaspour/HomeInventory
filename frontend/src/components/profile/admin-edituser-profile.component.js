...
const AdminEditUser = (props) =>  {
    ...
    const onSubmit = async e =>{
        if (formData.role===0 && props.user.role===1){
            alert('role must be user');
            return;
        }
        e.preventDefault();
        const config = {
        ...
        axios.post('http://localhost:5000/api/profile/update/'+ formData._id, body,config)
        .then(response => {
            alert(response.data)
                ...
                <div className="card-body">
                    ...
                    <div className="className=col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        ...
                        <div className="text-right te">
                            ...
                            <div className="text-right te">
                                <Link to="/" className="btn btn-primary button cancel">Cancel</Link>
                            </div>
                        </div>
                    </div>
                </div>
